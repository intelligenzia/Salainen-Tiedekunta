...
var teacherTemplate = path_1.default.resolve('../templates/teacher.tsx');
var createPages = function (_a) {
    var graphql = _a.graphql, actions = _a.actions, reporter = _a.reporter;
    return __awaiter(void 0, void 0, void 0, function () {
        var createPage, result, majors, teachers, courses;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    majors = result.data.allContentfulMajor.edges;
                    teachers = result.data.allTeachers.edges;
                    courses = result.data.allContentfulCourse.edges;
